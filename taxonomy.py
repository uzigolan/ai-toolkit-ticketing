...
BUILTIN = {
    ...
    "resolutions": [
        {"id": "fixed", "label": "Fixed — ready for verification",
         "status": "ready_for_verification", "requires_version": True,
         "requires_answer": True, "requires_note": False},
        {"id": "known_issue", "label": "Known issue — not fixed for now",
         "status": "known_issue", "requires_version": False,
